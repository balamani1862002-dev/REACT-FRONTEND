    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-3xl font-bold text-deep-indigo">Money Tracking</h1>
        </div>
        <div className="flex gap-2">
          <button
            onClick={() => window.location.href = '/analytics'}
            className="px-4 py-2 bg-white text-royal-purple border border-royal-purple rounded-lg font-medium hover:bg-royal-purple hover:text-white transition-all flex items-center gap-2"
          >
