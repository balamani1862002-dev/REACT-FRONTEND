...
import { useLoginViewModel } from './LoginScreen.vm';
import { Loader } from '../../reusables/Loader';

export const LoginScreen: React.FC = () => {
  const { state, loading, actions } = useLoginViewModel();
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-soft-lilac overflow-hidden">
      {/* Wavy Background */}
      ...
      <div className="relative z-10 max-w-md w-full mx-4 bg-white rounded-2xl shadow-2xl p-8 border border-light-lavender">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-deep-indigo mb-2">Welcome Back</h1>
          <p className="text-cool-gray text-sm">Sign in to continue to Money Manager</p>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              onKeyPress={(e) => e.key === 'Enter' && actions.handleLogin()}
            />
          </div>
        </div>
        ...
        <div className="text-center space-y-3">
          <button
            ...
            className="text-slate-purple hover:text-royal-purple text-sm font-medium transition-colors"
          >
            Forgot Password?
          </button>
          <p className="text-cool-gray text-sm">
            ...
            <button
              ...
              className="text-royal-purple hover:text-deep-purple font-semibold transition-colors"
            >
              Sign Up
            </button>
          </p>
