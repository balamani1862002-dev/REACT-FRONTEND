  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-3xl font-bold text-deep-indigo">User Management</h1>
      </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b-2 border-light-lavender">
                <th className="text-left py-3 px-4 text-deep-indigo font-semibold">Name</th>
                <th className="text-left py-3 px-4 text-deep-indigo font-semibold">Email</th>
                <th className="text-left py-3 px-4 text-deep-indigo font-semibold">Current Balance</th>
                <th className="text-left py-3 px-4 text-deep-indigo font-semibold">Remaining Todos</th>
                <th className="text-left py-3 px-4 text-deep-indigo font-semibold">Created</th>
                <th className="text-center py-3 px-4 text-deep-indigo font-semibold">Actions</th>
              </tr>
            </thead>
            <tbody>
                    ...
                    <td className="py-4 px-4">
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <button
                          ...
                          className="group relative flex h-10 w-10 flex-col items-center justify-center overflow-hidden rounded-xl border-2 border-red-800 bg-red-400 hover:bg-red-600 transition-colors"
                          title="Delete User"
                        >
                          {/* Lid SVG */}
                          <svg 
                          ...
                          {/* Bin Body SVG */}
                          <svg width={11} fill="none" viewBox="0 0 33 39">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-md w-full mx-4 transform transition-all">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-deep-indigo">Confirm Delete</h3>
                <p className="text-sm text-cool-gray">This action cannot be undone</p>
              </div>
            </div>
